...
const FrameModal: React.FC<FrameModalProps> = ({ isOpen, onRequestClose, frameUrl }) => {
  ...
  return (
    <Modal isOpen={isOpen} onRequestClose={onRequestClose} style={customStyles}>
      <div className="flex flex-col items-center bg-deepPink text-white font-semibold text-medium p-2 rounded-lg w-full max-w-full h-full max-h-full overflow-auto">
