...
const sendTip = async (
    ...
    async function setup() {    
        ...
        try {
            ...
            const sendThisToken = '0x4ed4E862860beD51a9570b96d89aF5E1B0Efefed'; // degen token address
            const degenTokenAmount = '30'; // degen token amount
            ...
            const txUiConfig = {
                ...
                description: `Send ${degenTokenAmount} DEGEN to d33m team?`,
                buttonText: 'Tip d33m team',
            };
            setNewPost(`Transaction is processing: ${degenTokenAmount} DEGEN. Please wait..`)
