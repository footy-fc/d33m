...
export const DefaultChannelName = "gantry"; // using 6 characters case sensative
//export const FarcasterHub = "https://hub.farcaster.standardcrypto.vc:2281";
export const FarcasterHub = "https://hypersnap.castrater.xyz";
